        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl font-semibold hover:opacity-90 transition"
            >
    ...
    <div className="min-h-screen relative">
      ...
      {isUploadModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm px-4">
          <div className="relative w-full max-w-lg bg-white rounded-2xl p-6 sm:p-8 shadow-2xl">
            <button
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="relative border-2 border-dashed border-slate-300 rounded-xl">
                <input
                  type="file"
                ...
                <div className="flex flex-col items-center justify-center py-10">
                  <Upload className="w-7 h-7 text-emerald-500 mb-2" />
              ...
              <button
                type="submit"
                disabled={uploading}
                className="w-full h-11 bg-linear-to-r from-emerald-500 to-teal-500 text-white rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
              >
      ...
      {isDeleteModalOpen && (<div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/ backdrop-blur-sm'>
        <div className='relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8'>
          ...
          className='absolute top-6 right-6 w-8 h-8 flex items-center justify-center rounded-sl text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-all duration-200'><X className='w-5 h-5' strokeWidth={2}/></button>
          {/* Modal Header */}
        <div className="mb-6">
          <div className="w-12 h-12 rounded-xl bg-linear-to-r from-red-100 to-red-200 flex items-center justify-center mb-4">
            <Trash2 className="w-6 h-6 red-600" strokeWidth={2} />
          </div>
